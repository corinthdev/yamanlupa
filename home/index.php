				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							...
							<p class="pt-10 pb-10" style="font-size: 15px; text-align: justify;"><strong class="text-warning">
							  ...
							  <a class="text-light primary-btn text-uppercase" readonly><?php echo $_SESSION['user']['fullname']; ?></a>
	                          <a href="../admin/logout.php" class="text-light primary-btn text-uppercase">LOGOUT</a>
						</div>										
					</div>
				</div>					
			</section>
