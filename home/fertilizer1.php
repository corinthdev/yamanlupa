...
<?php
            ...
            $carbon_show = $_REQUEST['carbon'];
            $phosphorous_show = $_REQUEST['phosphorous'];
            $potassium_show = $_REQUEST['potassium'];
            $sulfur_show = $_REQUEST['sulfur'];
            $zinc_show = $_REQUEST['zinc'];
...
<link rel="shortcut icon" type="image/x-icon" href="frontend_links/backend_images/icon.png" />
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                      <label>Halaman</label>
                                      <input class="form-control" type="text" value="<?php echo $acidity; ?>">
                                    </div>
                                    <div class="form-group">
                                      <label>Urea</label>
                                      <input class="form-control" id = "urea" type="text" value="<?php 

                                        if($acidity=='Rainfed Rice (WS)'){

                                            echo round($urea,2);
                                        }

                                        elseif($acidity=='Rainfed Rice (DS)'){

                                            echo round($urea2,2);
                                        }


                                        elseif($acidity=='Upland Rice (WS)'){
                                        ...
                                        elseif($acidity=='Peanut'){

                                            echo round($urea5,2);
                                        }
                                         elseif($acidity=='Mungbean'){

                                            echo round($urea6,2);
                                        }
                                        elseif($acidity=='Winged Beans'){

                                            echo round($urea7,2);
                                        }
                                         elseif($acidity=='String Beans'){

                                            echo round($urea8,2);
                                        }
                                          elseif($acidity=='Potato and Cassava'){
                                        ...
                                        elseif($acidity=='Tomato'){

                                            echo round($urea11,2);
                                        }
                                        elseif($acidity=='Bitter Gourd'){

                                            echo round($urea12,2);
                                        }
                                         elseif($acidity=='Eggplant'){

                                            echo round($urea13,2);
                                        }
                                         elseif($acidity=='Okra Hybrid'){

                                            echo round($urea14,2);
                                        }
                                        elseif($acidity=='Okra Local'){

                                            echo round($urea15,2);
                                        }
                                        elseif($acidity=='Squash'){
                                         ...
                                         elseif($acidity=='Patola'){

                                            echo round($urea18,2);
                                        }
                                         elseif($acidity=='Finger Pepper'){

                                            echo round($urea19,2);
                                        }
                                        elseif($acidity=='Petchay'){

                                            echo round($urea20,2);
                                        }
                                        elseif($acidity=='Mustard'){

                                            echo round($urea21,2);
                                        }
                                        elseif($acidity=='Watermelon'){

                                            echo round($urea22,2);
                                        }
                                         elseif($acidity=='Cabbage'){

                                            echo round($urea23,2);
                                        }
                                        elseif($acidity=='Cauliflower'){

                                            echo round($urea24,2);
                                        }
                                        elseif($acidity=='Spinach'){

                                            echo round($urea25,2);
                                        }
                                        elseif($acidity=='Onion/Garlic'){

                                            echo round($urea26,2);
                                        }
                                         elseif($acidity=='Ginger Improved'){

                                            echo round($urea27,2);
                                        }
                                        elseif($acidity=='Muskmelon'){

                                            echo round($urea28,2);
                                        }
                                        elseif($acidity=='Carrot'){

                                            echo round($urea29,2);
                                        }
                                        elseif($acidity=='Potato'){

                                            echo round($urea30,2);
                                        }
                                        elseif($acidity=='Chili'){

                                            echo round($urea31,2);
                                        }
                                        elseif($acidity=='Bell Pepper'){
                                    ...
                                    <div class="form-group">
                                      <label>16-20-0</label>
                                      <input class="form-control" id = "phosphorous" type="text" value="<?php 
                                    ...
                                    <div class="form-group">
                                      <label>0-0-60</label>
                                      <input class="form-control" id = "total_k" type="text" value="<?php 
                                    ...
                                    <div class="form-group">
                                      <label>21-0-0-24S</label>
                                      <input class="form-control" id = "total_s" type="text" value="<?php 
                                    ...
                                    <div class="form-group">
                                      <label>Zinc Sulfate</label>
                                      <input class="form-control" id = "zinc" type="text" value="<?php 
                                ...
                                <div class="col-lg-3"><br><br><br>
                                    <div style="margin-top: 16px;" class="form-group">
                                      <label>PHP</label>
                                      <input class="form-control" id="urea1" type="text" value="<?php echo $row['urea']; ?>" >
                                    </div>
                                    <div style="margin-top: " class="form-group">
                                      <label>PHP</label>
                                      <input class="form-control" id="phosphorous1" type="text" value="<?php echo $row['phosphorous1']; ?>" >
                                    </div>
                                    <div style="margin-top: " class="form-group">
                                      <label>PHP</label>
                                      <input class="form-control" id="total_k1" type="text" value="<?php echo $row['total_k']; ?>" >
                                    </div>
                                    <div style="margin-top: " class="form-group">
                                      <label>PHP</label>
                                      <input class="form-control" id="total_s1" type="text" value="<?php echo $row['total_s']; ?>" >
                                    </div>
                                    <div style="margin-top: " class="form-group">
                                      <label>PHP</label>
                                      <input class="form-control" id="zinc1" type="text" value="<?php echo $row['total_zn']; ?>" >
                                    </div>
                                <?php } ?>
                                </div>
                                <div class="col-lg-3">
                                    <div style="margin-top: 42%;" class="form-group">
                                      <label></label>
                                      <input class="form-control" id="total_urea" type="text" placeholder="Total Urea" readonly>
                                    </div>
                                    <div style="margin-top: 38px;" class="form-group">
                                      <label></label>
                                      <input class="form-control" id="total_phosphorous" type="text" placeholder="Total Phosphorous" readonly>
                                    </div>
                                    <div style="margin-top: 39px;" class="form-group">
                                      <label></label>
                                      <input class="form-control" id="total_kk" type="text" placeholder="Total K" readonly>
                                    </div>
                                    <div style="margin-top: 39px;" class="form-group">
                                      <label></label>
                                      <input class="form-control" id="total_ss" type="text" placeholder="Total S" readonly>
                                    </div>
                                    <div style="margin-top: 39px;" class="form-group">
                                      <label></label>
                                      <input class="form-control" id="total_znn" type="text" placeholder="Total ZN" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <select id="total_all" readonly>
                                        <option value="*">*</option>
                                    </select>
                                    <input type="button" class="btn btn-dark form-control" onClick="total();" Value="Calculate Total" />
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script type="text/javascript">
            function total()
            {
                ...
                var n3 = parseFloat(document.getElementById('phosphorous').value);
                var n4 = parseFloat(document.getElementById('phosphorous1').value);
                var n5 = parseFloat(document.getElementById('total_k').value);
                var n6 = parseFloat(document.getElementById('total_k1').value);
                var n7 = parseFloat(document.getElementById('total_s').value);
                var n8 = parseFloat(document.getElementById('total_s1').value);
                var n9 = parseFloat(document.getElementById('zinc').value);
                var n0 = parseFloat(document.getElementById('zinc1').value);
                
                oper = document.getElementById('total_all').value;
                
                if(oper === '*')
                {
                    total = document.getElementById('total_urea').value = n1*n2;
                    total = document.getElementById('total_phosphorous').value = n3*n4;
                    total = document.getElementById('total_kk').value = n5*n6;
                    total = document.getElementById('total_ss').value = n7*n8;
                    total = document.getElementById('total_znn').value = n9*n0;
                }
            }
        </script>
        <script type="text/javascript">
