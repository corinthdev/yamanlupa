...
$query = "SELECT * FROM dss_table_two WHERE id = '".$_GET["id"]."'";
...
{ 
  ...
  $update = "UPDATE dss_table_two SET dss_info ='$q', dss_krit ='$w', dss_observe ='$e', dss_result ='$r' WHERE id = '".$_GET["id"]."'";   
