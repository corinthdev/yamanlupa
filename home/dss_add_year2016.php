...
if (isset($_POST['save'])) {
			...
			if (count($errors) == 0) {
			    $sql = "INSERT INTO dss_table_one (dss_info, dss_krit, dss_observe, dss_result)
			    VALUES ('$dss_info', '$dss_krit', '$dss_observe', '$dss_result')";
			    $query = mysqli_query($conn, $sql);
				header('location: dss_add_year2016.php'); 
				exit();
			}
			mysqli_close($conn);
		  }
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">DSS PLATFORM 2016</h1>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
			                ...
			                <?php endif ?>
							<form method="POST" action="dss_add_year2016.php">
