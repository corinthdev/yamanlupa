                <?php
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO info(code,pangalan,barangay,bayan,lalawigan,lalim,sampling) 
                            VALUES('$code','$pangalan','$barangay','$bayan','$lalawigan','$lalim','$sampling')";
                         $query = mysqli_query($conn, $sql);
                         if($query){
                              $note1= "SUCCESSFULLY REGISTER INFO";
                             }
                             else{
                              $alert1= "ERROR";
                             }
    ...
    <?php include 'navigation/user_header.php' ?>
        ...
        <section class="events-list-area section-gap event-page-lists bg-light">
            <div class="container">
                    ...
                    <?php if (isset($note1)) {echo "<div class=\"alert alert-success\"><strong>Note: </strong>" .$note1. "</div>";}?>
                    <?php if (isset($alert1)) {echo "<div class=\"alert alert-danger\"><strong>Note: </strong>" .$alert1. "</div>";}?>
                    ...
                    <hr>
                    <p>Code: <?php echo $code_show;?>&nbsp;&nbsp;&nbsp;<a href="print.php" class="btn btn-info">Print SHC</a></p>
                <hr>
                <div class="row">
                    <div class="col-lg-3 border">
                        <div class="assessment-container container">
                            <h4 align="center" class="alert alert-success">Pangunahing Impormasyon</h4>
                            <hr>
                            <h4>Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $pangalan_show;?></h4>
                            <br>
                            <h4>Barangay: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $barangay_show;?></h4>
                            <br>
                            <h4>Bayan: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bayan_show;?></h4>
                            <br>
                            <h4>Lalawigan: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $lalawigan_show;?></h4>
                            <br>
                            <h4>Lalim: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $lalim_show;?></h4>
                            <br>
                            <h4>Sampling: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $sampling_show;?></h4>
                            <br>
                        </div>
                    </div>
                    <div class="col-lg-9 border">
                        <h3 align="center" class="alert alert-success">Resulta ng Soil Analysis</h3>
                        <hr>
                    ...
                    <div class="col-lg-6 border"><br>
                        <h3 align="center" class="alert alert-danger">Pangunahing Elemento</h3>
                        <hr>
                    ...
                    <div class="col-lg-6 border"><br>
                         ...
                         <h3 align="center" class="alert alert-danger">Sekondaryo Elemento</h3>
                        <hr>
                    ...
                    <div class="col-lg-12 border"><br>
                        <h3 align="center" class="alert alert-danger">Mirco Nutrients</h3>
                        <hr>
                    ...
                    <div class="col-lg-12 border"><br>
                        <h3 align="center" class="alert alert-success">Rekomendasyon sa Pataba (kilo kada ektarya)</h3>
                        <hr>
                    ...
                    <div class="col-lg-3"><br>
                        <a href="ylp_data.php" class="btn btn-success">Go to YLP DATA</a>
                    </div>
                </div>
            </div>	
        </section>
