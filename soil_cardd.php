                                    ...
                                    <div class="row border">
                                        <div class="col-lg-4 border"><br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pangalan" id="pangalan" value="<?php echo $description;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Baranggay</label><br>
                                                <input type="text" name="brgy" value="<?php echo $ylp_farmer;?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="bayan" id="bayan" value="<?php echo $ylp_lalawigan;?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sampling" id="sampling" value="<?php echo $taon;?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-4"><br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="width: 72%; padding: 11px; border-radius: 5px;" type="number" name="ph" placeholder="0.00" required name="price" min="0" max="14.99" value="<?php echo $ylp_crop;?>" step="0.01" title="Currency" pattern="^\d+(?:\.\d{1,2})?$" onblur="this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'inherit':'red'" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Exchangeable Acidity</label><br>
                                                <input type="text" name="exchange" value="<?php echo $ylp_exchange; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Electricity Conductivity</label><br>
                                                <input type="text" name="electricity" id="conduc" value="<?php echo $ylp_ec;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phosphorous" id="phospo" value="<?php echo $ylp_avail_p;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Available Potassium (PPM)</label><br>
                                                <input type="text" name="potassium" id="pota" value="<?php echo $ylp_avail_k;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Available Sulfur (PPM)</label><br>
                                                <input type="text" name="sulfur" id="sulfur" value="<?php echo $ylp_avail_s;?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-4"><br>
                                            <h5 class="text-center">Resulta ng Soil Analysis:</h5><hr>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="zinc" id="zinc" value="<?php echo $ylp_avail_zn;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Available Iron (PPM)</label><br>
                                                <input type="text" name="iron" id="iron" value="<?php echo $ylp_avail_b;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Available Copper (PPM)</label><br>
                                                <input type="text" name="copper" id="copper" value="<?php echo $ylp_avail_cu;?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Available Manganese (PPM)</label><br>
                                                <input type="text" name="manganese" id="manga" value="<?php echo $ylp_avail_mn;?>" readonly>
                                            </div><br>
